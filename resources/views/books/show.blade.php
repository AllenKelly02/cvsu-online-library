<x-app-layout>
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" class="lg:w-1/2 w-36 lg:h-auto h-36 object-cover object-center rounded"  src="{{ asset('img/b1.jpg') }}" alt="content">
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        <h2 class="text-sm title-font text-gray-500 tracking-widest">Book</h2>
        ...
        <div class="flex mt-6 items-center pb-5 border-b-2 border-green-900 mb-5">
          {{-- <div class="flex">
