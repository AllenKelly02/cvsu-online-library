<x-app-layout>
  ...
  <div class="container px-4 mx-auto">
    <div class="p-8 bg-white rounded-xl">
      <div class="flex flex-wrap items-center justify-between -mx-4 mb-8 pb-6 border-b border-black border-opacity-20">
        ...
        <div class="w-full sm:w-auto px-4">
          <div>
          <a class="inline-block py-2 px-4 mr-3 text-xs leading-normal bg-green-600 rounded-3xl p-3 text-center text-white font-bold transition duration-200 hover:bg-green-800 href="#">Cancel</a>
          <a class="inline-block py-2 px-4 text-xs leading-normal border-green-600 hover:border-green-800 hover:bg-green-800 hover:text-white hover:border-[2px] border-[1px] rounded-3xl p-3 text-center text-green-800 font-bold transition duration-200" href="#">Upload</a></div>
        </div>
      </div>
      <form action="">
            ...
            <div class="max-w-xl">
              <div class="flex flex-wrap items-center -mx-3">
                <div class="w-full sm:w-1/2 px-3 mb-3 sm:mb-0">
                  <input class="block py-4 px-3 w-full text-sm text-black placeholder-black font-medium outline-none bg-transparent border border-black hover:border-black focus:border-green-500 rounded-lg" id="formInput1-1" type="text" placeholder="Title">
                </div>
                {{-- <div class="w-full sm:w-1/2 px-3">
                  <input class="block py-4 px-3 w-full text-sm text-black placeholder-black font-medium outline-none bg-transparent border border-black hover:border-black focus:border-green-500 rounded-lg" id="formInput1-2" type="text" placeholder="Name">
                </div> --}}
              </div>
            </div>
          </div>
         ...
         <div class="flex flex-wrap items-center -mx-4 pb-8 mb-8 border-b border-black border-opacity-20">
          ...
          <div class="w-full sm:w-2/3 px-4">
            <div class="max-w-xl">
              <div class="flex flex-wrap items-center -mx-3">
                <div class="w-full sm:w-1/2 px-3 mb-3 sm:mb-0">
                  <input class="block py-4 px-3 w-full text-sm text-black placeholder-black font-medium outline-none bg-transparent border border-black hover:border-black focus:border-green-500 rounded-lg" id="formInput1-1" type="text" placeholder="Number">
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="flex flex-wrap items-center -mx-4 pb-8 mb-8 border-b border-black border-opacity-20">
          ...
          <div class="w-full sm:w-2/3 px-4">
            <div class="max-w-xl">
              <input class="block py-4 px-3 w-full text-sm text-black placeholder-black font-medium outline-none bg-transparent border border-black hover:border-black focus:border-green-500 rounded-lg" id="formInput1-3" type="text" placeholder="Author 1">
            </div>
            <div class="max-w-xl">
              <input class="block py-4 px-3 w-full text-sm text-black placeholder-black font-medium outline-none bg-transparent border border-black hover:border-black focus:border-green-500 rounded-lg" id="formInput1-3" type="text" placeholder="Author 2">
            </div>
            <div class="max-w-xl">
              <input class="block py-4 px-3 w-full text-sm text-black placeholder-black font-medium outline-none bg-transparent border border-black hover:border-black focus:border-green-500 rounded-lg" id="formInput1-3" type="text" placeholder="Author 3">
            </div>
          </div>
        </div>
        <div class="flex flex-wrap items-start -mx-4 pb-8 mb-8 border-b border-black border-opacity-20">
          ...
          <div class="w-full sm:w-2/3 px-4">
            <div class="max-w-xl"><textarea class="block h-56 py-4 px-3 w-full text-sm text-black placeholder-black font-medium outline-none bg-transparent border border-black hover:border-black focus:border-green-500 rounded-lg resize-none" id="formInput1-9" type="text" placeholder="Write the description"></textarea></div>
          </div>
        </div>
        {{-- <div class="flex flex-wrap items-start -mx-4 pb-8 mb-8 border-b border-black border-opacity-20">
        ...
        <div class="flex flex-wrap items-center -mx-4 pb-8 mb-8 border-b  border-opacity-20">
          ...
          <div class="w-full sm:w-2/3 px-4">
            <div class="max-w-xl">
              <div class="relative block px-3 w-full text-sm text-black placeholder-black font-medium border border-black hover:border-black rounded-lg">
        ...
        <div class="flex flex-wrap items-start -mx-4 pb-8 mb-8 border-b border-black border-opacity-20">
          <div class="w-full sm:w-1/3 px-4 mb-6 sm:mb-0">
            <span class="block text-sm font-medium text-black">Photo</span>
            <span class="text-xs text-black">Upload photo of the book cover, manuscript, or journal.</span>
          </div>
          <div class="w-full sm:w-2/3 px-4">
            <div class="flex flex-wrap sm:flex-nowrap max-w-xl">
              <div class="flex-shrink-0 w-20 h-20 mb-4 mr-4 rounded-full">
