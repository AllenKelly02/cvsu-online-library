<x-app-layout>
<section class="text-gray-600 body-font ml-32">
    ...
    <div class="flex flex-col md:w-1/2 md:pl-12">
      ...
      <nav class="flex flex-wrap list-none -mb-1">
        <li class="lg:w-1/3 mb-1 w-1/2">
          <a href = "https://www.google.com/maps?ll=14.412771,120.981349&z=19&t=h&hl=en-US&gl=US&mapclient=embed&cid=12613929739887301784" class="text-gray-600 hover:text-green-500">CvSU - Bacoor Campus on Google Map</a>
        </li>
        <li class="lg:w-1/3 mb-1 w-1/2">
          <a href = "https://www.facebook.com/CvSUBacoorCityCampusLibrary/" class="text-gray-600 hover:text-green-500">Campus Library FB Page</a>
        </li>
        <li class="lg:w-1/3 mb-1 w-1/2">
          <a href = "https://cvsubccl.librarika.com/" class="text-gray-600 hover:text-green-500">Web OPAC</a>
        </li>
        {{-- <li class="lg:w-1/3 mb-1 w-1/2">
