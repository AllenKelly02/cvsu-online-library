        ...
        <div class="flex flex-wrap">
            <div class="p-4 sm:w-full md:w-1/2">
                <div class="h-full bg-white shadow-2xl p-8 rounded">
                    ...
                    <p class="leading-relaxed mb-6 text-justify">Cavite State University shall provide excellent, equitable and relevant educational opportunities in the arts, sciences and technology through quality instruction and responsive research and development activities. It shall produce professional, skilled and morally upright individuals for global competitiveness.<br></p>
            ...
            <div class="p-4 sm:w-full md:w-1/2">
                <div class="h-full bg-white shadow-2xl p-8 rounded">
                    ...
                    <p class="leading-relaxed mb-6 text-justify">The premier university in historic Cavite globally recognized for excellence in character development, academics, research, innovation and sustainable community engagement.<br><br><br></p>
