<section class="w-full pt-58 text-gray-600 body-font bg-bottom bg-no-repeat" style="background-image: url('../img/wave.svg');">
  ...
  <div class="w-full container mx-auto flex md:flex-row flex-col items-center md:space-x-32 lg:px-28 py-16 pb-44">
        ...
        <div class="lg:max-w-lg lg:w-96 md:w-1/2 w-5/6 pt-5">
            <img class="object-cover object-center rounded sm:flex-shrink" alt="hero" src="{{ asset('img/liba.png') }}">
        </div>
...
<section class="text-gray-600 body-font h-96 sm:flex-shrink-0 sm: bg-gradient-to-b from-green-200 to-emerald-400">
  <div class="container px-5 mx-auto lg:px-28 py-16 pt-0">
    {{-- <h1 class="text-3xl font-medium title-font text-gray-900 mb-12 text-center">Testimonials</h1> --}}
    <div class="flex flex-wrap ">
      <div class="p-4 sm:w-5/6 md:w-1/2 w-full">
        <div class="h-full bg-green-100 p-8 rounded">
