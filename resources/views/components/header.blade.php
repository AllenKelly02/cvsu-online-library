    ...
    <div class="w-full z-50 border-b border-green-800 bg-green-200">
        <div class="navbar flex sticky justify-between items-center container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex space-x-2 justify-center">
                @auth
                    <form class="sm:inline-block hidden sm:block">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="default-search" class="block w-full sm:w-64 p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500" placeholder="Search title of books, authors" required>
