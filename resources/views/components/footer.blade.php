<footer class="bottom-0 top-0 left-0 text-gray-600 body-font">
    <div class="border-t border-green-800 bg-green-200">
        <div class="container mx-auto py-4 px-5 md:px-22 mt-3 lg:px-28 flex flex-wrap flex-col sm:flex-row">
          ...
          <span class="sm:ml-auto sm:mt-0 mt-2 sm:w-auto w-full sm:text-left text-center text-gray-900 text-sm">Online Library</span>
        </div>
    </div>
</footer>
