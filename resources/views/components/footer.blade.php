<footer class="bottom-0 text-gray-600 content w-auto t bg-green-100">
        <div class="container h-15 py-5 px-5 md:px-22 lg:px-28 flex flex-wrap flex-col sm:flex-row ">
