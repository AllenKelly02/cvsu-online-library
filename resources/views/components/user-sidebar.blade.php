...
<div class="w-100 h-full flex items-start justify-center border-r border-gray-300">
    <div class="flex flex-col space-y-1 p-8 justify-left">
        ...
        <a href="{{ route('user.top-collect') }}" class="flex items-center space-x-2 p-2 rounded group hover:bg-green-300">
        ...
        <a href="{{ route('user.new-collections') }}" class="flex items-center space-x-2 p-2 rounded group hover:bg-green-300">
            <i class='bx bx-book text-xl text-gray-500 group-hover:text-black-900'></i>
            <p class="group-hover:text-green-700">New Collections</p>
        </a>

        <a href="{{ route('user.about-us') }}" class="flex items-center space-x-2 p-2 rounded group hover:bg-green-300">
            <i class='bx bx-book text-xl text-gray-500 group-hover:text-black-900'></i>
            <p class="group-hover:text-green-700">About Us</p>
        </a>

        <a href="{{ route('user.ask-librarian') }}" class="flex items-center space-x-2 p-2 rounded group hover:bg-green-300">
            <i class='bx bx-book text-xl text-gray-500 group-hover:text-black-900'></i>
