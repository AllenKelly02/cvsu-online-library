<body class="flex items-center justify-center w-screen h-screen p-10 space-x-6 bg-green-50">
    ...
    <div class="wrapper">
        <div class="sidebar">
            <div
                class="flex flex-col items-center w-60 h-full overflow-hidden border-r border-green-800 text-gray-700 bg-green-50 rounded">
                ...
                <div class="w-full px-2">
                    <div class="flex flex-col items-center w-full mt-3 border-t border-green-800 focus-visible">
                        <a href="{{ route('user.catalog') }}"
                            class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-green-600 hover:text-white {{ request()->routeIs('user.catalog') ? 'bg-green-600 text-white' : '' }}">
                        ...
                        <a href="{{ route('user.top-collect') }}"
                            class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-green-600 hover:text-white {{ request()->routeIs('user.top-collect') ? 'bg-green-600 text-white' : '' }}">
                        ...
                        <a href="{{ route('user.new-collections') }}"
                            class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-green-600 hover:text-white {{ request()->routeIs('user.new-collections') ? 'bg-green-600 text-white' : '' }}">
                        ...
                        <a href="{{ route('user.about-us') }}"
                            class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-green-600 hover:text-white {{ request()->routeIs('user.about-us') ? 'bg-green-600 text-white' : '' }}">
                        ...
                        <a href="{{ route('user.ask-librarian') }}"
                            class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-green-600 hover:text-white {{ request()->routeIs('user.librarian') ? 'bg-green-600 text-white' : '' }}">
                        ...
                        <a href="{{ route('user.borrow-history') }}"
                            class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-green-600 hover:text-white {{ request()->routeIs('user.borrow-history') ? 'bg-green-600 text-white' : '' }}">
