    ...
    <div class="min-w-screen min-h-screen bg-gray-100 flex items-center justify-center px-5 py-5">
        <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style="max-width:1000px">
            <div class="md:flex w-full">
                ...
                <div class="w-full md:w-1/3.5 py-10 px-5 md:px-10 bg-white" x-data="storeAccount">
                    ...
                    <div>
                        ...
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-5">
                                <button
                                    class="block w-full max-w-xs mx-auto bg-green4 hover:bg-green3 text-white rounded-lg px-3 py-3 font-semibold">Back
                                    to login</button>
                            </div>
                            <div class="w-full px-3 mb-5">
                                <button
