                        ...
                        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg space-y-4">
                                ...
                                <div class="max-w-xl">
                                    ...
                                    <input type="text" disabled autocomplete="off" name="author"
                                        class="text-left border-bluemain rounded-lg w-full text-black"
                                        value="{{ $profile->profile->first_name }} {{ $profile->profile->middle_name }} {{ $profile->profile->last_name }}">
                                </div>
                                <div class="max-w-xl">
